...
passwordInput.addEventListener("input", updatesStrengthMeter)
updatesStrengthMeter()

function updatesStrengthMeter() {
  ...
  strengthMeter.setAttribute("data-content", `${strength}%`)
  //
